...
void AudioCapture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->audioLevelChanged((*reinterpret_cast< std::add_pointer_t<qreal>>(_a[1]))); break;
        case 2: _t->errorOccurred((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AudioCapture::*)(const QByteArray & )>(_a, &AudioCapture::audioDataReady, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (AudioCapture::*)(qreal )>(_a, &AudioCapture::audioLevelChanged, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (AudioCapture::*)(const QString & )>(_a, &AudioCapture::errorOccurred, 2))
            return;
    }
}
...
// SIGNAL 0
void AudioCapture::audioDataReady(const QByteArray & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void AudioCapture::audioLevelChanged(qreal _t1)
{
